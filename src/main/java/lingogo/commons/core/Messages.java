...
public class Messages {
    ...
    public static final String MESSAGE_IN_SLIDESHOW_MODE = "This command can only be run when slideshow mode is not active!";
    public static final String MESSAGE_NOT_IN_SLIDESHOW_MODE = "This command can only be run when slideshow mode is active!";
